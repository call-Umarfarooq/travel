...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <div className="flex-grow flex mt-28 items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-md w-full space-y-8 bg-white p-8 rounded-2xl shadow-sm">
          ...
          <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="text-center text-sm">
                Already have an account? <Link href="/login" className="text-primary hover:text-primary-dark">Sign In</Link>
            </div>
          </form>
        </div>
      </div>
